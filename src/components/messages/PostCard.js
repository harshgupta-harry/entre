            ...
            <div>
              <Grid container spacing={0} className={classes.firstRightCol} alignItems="center">
                <Grid item xs={12} sm={8}>
                  {thread.participantsInfo.map((participant, idx) => {
                    if (userAuth.uid !== participant.id && idx < 3) {
                      ...
                      displayCounter++;
                      return (
                        <Typography variant="inherit" component="span" className={[classes.singleUserName, updatedTitleStyle]}>
                  ...
                  {thread.participantsInfo.length > 4 && (
                    ...
                    >
                      <Grid item xs={12} sm={2} align="right">
                        <Typography className={classes.userMessageTime} variant="body2" component="p">
                          {`+${thread.participantsInfo.length - 4}`}
                        </Typography>
                      </Grid>
                    </div>
                ...
                <Grid item xs={12} sm={4} align="right">
                  <Typography className={[classes.userMessageTime, updatedTimeStyle]} variant="body2" component="p">
                    {moment(
              ...
              <Grid container spacing={0}>
                <Grid item xs={12} sm={10}>
                  <Typography className={[classes.userMessageText, userMessageTextStyle]} variant="body2" component="p">
