...
function StripeForm(props) {
  const { membership, onClose, email: propEmail } = props;
  ...
  return (
    <Grid container justify="center">
      <Grid item sm={4}>
        <Box textAlign="left" mb={5} minWidth="370px">
          <Card>
              ...
              {loading ? (
                ...
                <>
                  <Box mb={2}>
                    ...
                    <Typography variant="subtitle2" style={{ textTransform: 'capitalize', fontWeight: 'bold' }}>
                      Pro
                      {' '}
                      {membership}
                      {' - '}
                  ...
                  <Box display="flex" flexDirection="row" alignItems="center" justifyContent="space-between">
                    <Typography variant="subtitle2" style={{ marginTop: 0 }}>New Credit or Debit Card</Typography>
                    <Box>
                      <img src="images/cards/1.png" alt="visa" style={{ width: 40 }} />
                      <img src="images/cards/2.png" alt="visa" style={{ width: 40 }} />
                      <img src="images/cards/22.png" alt="visa" style={{ width: 40 }} />
                    </Box>
                  </Box>
                  <Box mt={2} mb={2}>
                    <CardElement
