...
//                         will not be removed.
export default function getTextBoundingRect(input, selectionStart, selectionEnd, debug) {
  ...
  for (let i = 0; i < listOfModifiers.length; i += 1) {
  ...
  fakeClone.style.left = `${leftPos + 30}px`;
  ...
  const getBoundingClientRect = () => returnValue;
  return {
